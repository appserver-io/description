...
/**
 * AppserverIo\Description\MethodInvocationAwareDescriptorInterface
 *
 * NOTICE OF LICENSE
 *
...
interface MethodInvocationAwareDescriptorInterface
{
     ...
     *
     * @param \AppserverIo\Description\MethodInvocationDescriptorInterface $method The method descriptor to add
     *
     * @return void
     */
