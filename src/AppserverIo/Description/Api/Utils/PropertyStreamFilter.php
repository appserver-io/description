...
/**
 * AppserverIo\Description\Api\Utils\PropertyStreamFilter
 *
 * NOTICE OF LICENSE
 *
...
namespace AppserverIo\Description\Api\Utils;
...
class PropertyStreamFilter extends \php_user_filter
{
     ...
     * @var string
     */
    const NAME = 'appserver-io.description.api.utils.property-stream-filter';
