...
/**
 * \AppserverIo\Description\Api\Node\PostDetachNode
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\Description\Configuration\PostDetachConfigurationInterface;

/**
 * DTO to transfer post detach information.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class PostDetachNode extends AbstractNode implements PostDetachConfigurationInterface
{
