...
/**
 * \AppserverIo\Description\Api\Node\PreAttachNode
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\Description\Configuration\PreAttachConfigurationInterface;

/**
 * DTO to transfer pre attach information.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class PreAttachNode extends AbstractNode implements PreAttachConfigurationInterface
{
