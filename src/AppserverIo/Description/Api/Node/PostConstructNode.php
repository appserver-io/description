...
/**
 * \AppserverIo\Description\Api\Node\PostConstructNode
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\Description\Configuration\PostConstructConfigurationInterface;

/**
 * DTO to transfer post construct information.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class PostConstructNode extends AbstractNode implements PostConstructConfigurationInterface
{
